...
#define OLED_SCREENSAVER_TIMEOUT  9 * MINUTE_TO_MS  // 10 Seconds of no activity, turn on the screensaver
#define OLED_TIMEOUT              12 * MINUTE_TO_MS  // 20 Seconds of no activity, turn off the OLED
