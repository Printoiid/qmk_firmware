 ...
 *            |      |      |    |         |/       /         \      \ |      |      |       |       |
 *            '----------------------------''------'           '------''-----------------------------'
 *  Some notes for this layer:
 *  - Comma and period are for moving Kitty terminal tabs forward or backwards
 *  - W on the far right is to close a tab
 */

[_CHARACTERS] = LAYOUT(
   KC_DEL,  XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_ASTR,                     XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX,       XXXXXXX, XXXXXXX,
   KC_GRV,  KC_QUOT, KC_DQT,  KC_LPRN, KC_RPRN, KC_PLUS,                     KC_W,    KC_P3,         KC_UP,      KC_PDOT,       KC_PGUP, XXXXXXX,
